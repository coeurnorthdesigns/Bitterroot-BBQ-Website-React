...
const Navbar31 = (props) => {
  return (
    <header className="navbar31-container">
      <img
        alt={props.imageAlt}
        src={props.imageSrc}
        className="navbar31-image"
      />
      <header data-thq="thq-navbar" className="navbar31-navbar-interactive">
        <div data-thq="thq-navbar-nav" className="navbar31-desktop-menu">
          <nav className="navbar31-links">
            <Link to="/" className="navbar31-link1 thq-link thq-body-small">
              {props.link1}
            </Link>
            <Link
              to="/page-pricing"
              className="navbar31-link3 thq-link thq-body-small"
            >
              {props.link3}
            </Link>
            <a
              href="#contact-form-7-email"
              className="navbar31-link4 thq-link thq-body-small"
            >
              {props.link4}
            </a>
          </nav>
        ...
        <div data-thq="thq-burger-menu" className="navbar31-burger-menu">
          <svg viewBox="0 0 1024 1024" className="navbar31-icon">
        ...
        <div data-thq="thq-mobile-menu" className="navbar31-mobile-menu">
          <div className="navbar31-nav">
            <div className="navbar31-top">
              ...
              <div data-thq="thq-close-menu" className="navbar31-close-menu">
                <svg viewBox="0 0 1024 1024" className="navbar31-icon02">
          ...
          <div className="navbar31-icon-group">
            <svg
...
Navbar31.defaultProps = {
  imageSrc: '/bitterroot%20red%20fonts%20trans-300w.png',
  imageAlt: 'image',
  link4: 'Contact',
  link3: 'Services',
  link5: 'FAQ',
