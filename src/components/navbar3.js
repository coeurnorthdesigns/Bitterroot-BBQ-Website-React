      ...
      <header data-thq="thq-navbar" className="navbar3-navbar-interactive">
        <div data-thq="thq-navbar-nav" className="navbar3-desktop-menu">
          <nav className="navbar3-links">
            <Link to="/" className="navbar3-link1 thq-link thq-body-small">
              {props.link1}
            </Link>
            <Link
              to="/page-pricing"
              className="navbar3-link3 thq-link thq-body-small"
            >
              {props.link3}
            </Link>
            <a
              href="#contact-form-7-email"
              className="navbar3-link4 thq-link thq-body-small"
            >
              {props.link4}
            </a>
          </nav>
          <div className="navbar3-icon-group"></div>
        </div>
        <div data-thq="thq-burger-menu" className="navbar3-burger-menu">
          <svg viewBox="0 0 1024 1024" className="navbar3-icon">
